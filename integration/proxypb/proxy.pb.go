...
var file_proxy_proto_rawDesc = []byte{
	...
	0x22, 0x14, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x22, 0x05, 0x2f, 0x65, 0x63, 0x68, 0x6f, 0x3a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x52, 0x0a, 0x11, 0x54, 0x65, 0x73, 0x74, 0x4d, 0x6f,
	...
	0x64, 0x65, 0x6c, 0x22, 0x15, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0f, 0x22, 0x0a, 0x2f, 0x74, 0x65,
	0x73, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x3a, 0x01, 0x2a, 0x12, 0x5a, 0x0a, 0x09, 0x50, 0x61,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x1d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x22,
	0x12, 0x2f, 0x70, 0x61, 0x74, 0x68, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x2f, 0x7b, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x7d, 0x3a, 0x01, 0x2a, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
func file_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proxy_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestModel_NestedChild); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proxy_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
